...
const rows = [
  createData('Pedro', 25, '2023-09-12', '97LPM', 1.75),
  createData('Ana', 30, '2023-08-30', '95LPM', 1.65),
  createData('Luis', 28, '2023-09-05', '68LPM', 1.80),
  createData('Maria', 32, '2023-09-18', '70LPM', 1.60),
  createData('Carlos', 27, '2023-09-10', '60LPM', 1.78),
];

export const TablaFrecuencia: React.FC = () => {
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Medida&nbsp;(LPM)</TableCell>
